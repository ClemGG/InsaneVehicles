...
public class Road {
    ...
    public Road(final int width, final int height, final int view, final int quota) {
        ...
        //Fonction dépréciée, on l'effacera surement après
        this.fillOnTheRoad();
    }
    ...
    public Coordinate getOnTheRoad(MobileElement element)
    {
	...
	public Element removeOnTheRoad(Coordinate coor, Element element) {
		// TODO Auto-generated method stub
		Element ancien = getOnTheRoadXY(coor.getX(), coor.getY());
		setOnTheRoadXY(element, coor.getX(), coor.getY());
		return ancien;
	}
